...
```{r}
ggplot(top_10_lojas, aes(x = reorder(cod_loja, receita_total), y = receita_total)) +
  geom_col(fill = "blue") +  # cor única para todas as barras
  labs(title = "Top 10 Lojas por Receita em Maio de 2024", x = "Loja", y = "Receita Total (R$)") +
  theme_minimal() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
